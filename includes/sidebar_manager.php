...
<aside id="main-sidebar" class="fixed inset-y-0 left-0 z-50 w-72 bg-white lg:static lg:translate-x-0 -translate-x-full transition-transform duration-300 ease-in-out glass-sidebar border border-indigo-100 flex flex-col p-6 shadow-xl shrink-0">
   ...
   class="<?php echo ($currentPage === 'dashboard.php')
    ...
    <div class="space-y-4">
        <!-- <div class="bg-indigo-50 p-4 md:p-6 rounded-[25px] md:rounded-[35px]">
            <p class="text-[9px] md:text-[10px] text-indigo-400 font-bold uppercase tracking-widest mb-1 md:mb-2">Hỗ trợ</p>
            <p class="text-xs md:text-sm text-indigo-900 font-bold leading-tight">Liên hệ phòng công tác sinh viên để được hỗ trợ.</p>
        </div> -->
