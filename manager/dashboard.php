                ...
                <div class="club-card bg-white border rounded-2xl overflow-hidden shadow-sm"
                    ...
                    <div class="club-header p-5 flex items-center justify-between cursor-pointer hover:bg-slate-50 transition"
                        ...
                        <div class="flex items-center gap-4">
                            <div class="w-10 h-10 md:w-14 md:h-14 bg-blue-50 rounded-xl md:rounded-2xl flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500">
                                    <?= $memberCount ?> thành viên  • 3 yêu cầu mới
                                </p>
                            </div>
                        </div>
                         <div class="flex items-center gap-4">
                            ...
                            <button
                                    onclick="event.stopPropagation(); deleteClub(<?= $clubID ?>)"
...
<button
    ...
    Lưu câu lạc bộ
        ...
        <aside id="sport-panel"
        class="fixed right-0 top-0 h-full w-96 bg-white shadow-2xl z-50
        ...
        <!-- Danh sách -->
        <div id="sport-list" class="px-6 space-y-2 overflow-y-auto">
            <?php foreach ($sports as $sport): ?>
